      ...
      <div className="flex-second__container">
        <div className="flex-second__box">
          ...
          <p>
            ...
            necessitatibus sapiente modi laudantium!
          </p>
        ...
        <div className="flex-second__box">
          ...
          <p>
            ...
            veniam, sint vel non reiciendis molestiae accusantium unde, quas
            voluptatibus fugiat, eos corrupti.{" "}
          </p>
