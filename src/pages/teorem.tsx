    ...
    <div className="teorem">
      <div className="teorem__header">
          ...
          <nav>
            ...
            <button className="teorem__header__transparent"><span>Sign in</span></button>
      ...
      <div className="teorem__section">
        ...
        <h1>Start tutoring<br></br>online</h1>
        <p>Give lessons whenever you want,<br></br>from the comfort your home.</p>
      </div>
